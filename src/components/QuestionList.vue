    ...
    <div class="main-content-inner">
      ...
      <div class="news-list-detail" v-for="item in items">
        ...
        <div class="feed-main">
          ...
          <div class="content">
            <h2><a <a href="#" v-link="{name:'question',params:{questionId:item.questionId}">{{item.questionTitle}}</a></h2>
          </div>
          <div class="entry-body">
            <div class="votebar">
              <a href="#" @click="up(item.answerId, item.upNum)" class="up" title="赞同"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span><span>{{item.upNum}}</span></a>
              <a href="#" class="down" title="反对，不会显示你的姓名"><span class="glyphicon glyphicon-thumbs-down" aria-hidden="true"></span></a>
            </div>
